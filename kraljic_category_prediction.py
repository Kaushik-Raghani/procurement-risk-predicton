...
model = joblib.load("random_forest_kraljic_model.joblib")
...
if submit_button:
    ...
    category_map = {0: 'Strategic', 1: 'Bottleneck', 2: 'Leverage', 3: 'Non-Critical'}
    prediction_label = category_map[prediction]
    st.success(f"Predicted Kraljic Category: **{prediction_label}**")
